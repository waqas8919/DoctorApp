...
class CreditCardPage extends StatefulWidget {
  ...
  CreditCardPage(this.carpost, this.appBarTitle);
...
class _CreditCarScreenState extends State<CreditCardPage> {
            ...
            Row(
              children: <Widget>[
                StreamBuilder<String>(
                    ...
                    builder: (context, snapshot) {
                      snapshot.data.length > 0
                          ? nameMask.updateText(snapshot.data)
                          : null;
                      print(snapshot.data);
                      return ProfileTile(
                        textColor: Colors.white,
                ...
                StreamBuilder<String>(
                    stream: cardBloc.amountOutputStream,
                    initialData: "",
                    builder: (context, snapshot) {
                      snapshot.data.length > 0
                          ? amountMask.updateText(snapshot.data)
                          : null;
                      print(snapshot.data);
                      return ProfileTile(
                        textColor: Colors.white,
