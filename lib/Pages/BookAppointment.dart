...
class BookAppointmentScreen extends StatefulWidget {
  ...
  BookAppointmentScreen(this.note, this.appBarTitle);
...
class _FiltersAppointmentState extends State<BookAppointmentScreen> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  DBHelper helper = DBHelper();
  String dropdownValue = 'TeleConsultation';
  ...
  String AppointTypes;
  String AppointmentTimeing;

  @override
  Widget build(BuildContext context) {
    NoteText.text = note.note;
    Name = note.doctorname;
    AppointTypes = note.appointmentType;
...
//                      Name) : Text("No Doctor selected"),
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          DropdownButton<String>(
            ...
            items: <String>['TeleConsultation', 'New Follow Up']
        ...
        child: Wrap(
          ...
          children: <Widget>[
            RaisedButton(
              ...
              child: Text("9:00"),
              color: AppointmentTime.text == "9:00" + " - " + "9:20"
                  ? Colors.red
                  : pressAttention
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
                          ? Colors.blue
                          : Colors.blue[900],
            ),
            RaisedButton(
              ...
              child: Text("9:20"),
              color: AppointmentTime.text == "9:20" + " - " + "9:40"
                  ? Colors.red
                  : pressAttention1
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
            ...
            RaisedButton(
              ...
              child: Text("9:40"),
              color: AppointmentTime.text == "9:40" + " - " + "10:00"
                  ? Colors.red
                  : pressAttention2
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
            ...
            RaisedButton(
              ...
              child: Text("10:00"),
              color: AppointmentTime.text == "10:00" + " - " + "10:20"
                  ? Colors.red
                  : pressAttention3
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
            ...
            RaisedButton(
              ...
              child: Text("10:20"),
              color: AppointmentTime.text == "10:20" + " - " + "10:40"
                  ? Colors.red
                  : pressAttention4
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
            ...
            RaisedButton(
              ...
              child: Text("10:40"),
              color: AppointmentTime.text == "10:40" + " - " + "11:00"
                  ? Colors.red
                  : pressAttention5
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
            ...
            RaisedButton(
              ...
              child: Text("11:00"),
              color: AppointmentTime.text == "11:00" + " - " + "11:20"
                  ? Colors.red
                  : pressAttention6
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
            ...
            RaisedButton(
              ...
              child: Text("11:20"),
              color: AppointmentTime.text == "11:20" + " - " + "11:40"
                  ? Colors.red
                  : pressAttention7
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
            ...
            RaisedButton(
              ...
              child: Text("11:40"),
              color: AppointmentTime.text == "11:40" + " - " + "12:00"
                  ? Colors.red
                  : pressAttention8
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
            ...
            RaisedButton(
              ...
              child: Text("12:00"),
              color: AppointmentTime.text == "12:00" + " - " + "12:20"
                  ? Colors.red
                  : pressAttention9
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
            ...
            RaisedButton(
              ...
              child: Text("12:20"),
              color: AppointmentTime.text == "12:20" + " - " + "12:40"
                  ? Colors.red
                  : pressAttention10
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
            ...
            RaisedButton(
              ...
              child: Text("12:40"),
              color: AppointmentTime.text == "12:40" + " - " + "13:00"
                  ? Colors.red
                  : pressAttention11
                      ? HotelAppTheme.buildLightTheme().primaryColor
                      : dropdownValue == 'TeleConsultation'
  ...
  UpdateAppointmentType() {
    note.appointmentType = dropdownValue;
  }
  ...
  void _save() async {
    ...
    if (AppointmentTime.text == '') {
      AppointmentTime.text = note.slottime;
      print(AppointmentTime.text);
    }
    note.slottime = AppointmentTime.text;
