...
import 'package:doctorapp/TeleConsult/SQFLITEMODEL/user_SQFLITE.dart';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Hero(
                      tag: 'logo',
                      child: Container(
                          width: 150.0, child: Image.asset("res/doclogo.png")),
                    ),
                    //USERNAME section
                    SizedBox(
                      height: 20.0,
                    ...
                    TextFormField(
                      ...
                      validator: (val) => val.isEmpty
                          ? FlutterI18n.translate(context, 'app.enteranemail')
                          : null,
                    ...
                    TextFormField(
                      ...
                      validator: (val) => val.length < 3
                          ? FlutterI18n.translate(context, 'app.enterapassword')
                          : null,
                      textAlign: TextAlign.center,
                      obscureText: true,
                      onChanged: (val) {
                    ...
                    RaisedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (_formKey.currentState.validate()) {
                          ...
                          if (result == null) {
                            setState(() => error = FlutterI18n.translate(
                                context, 'app.emailpasswordincorrect'));
                          }
                    ...
                    Text(
                      error,
                      style: TextStyle(
                          color: Colors.red, fontFamily: 'IndieFlower'),
                    )
                  ],
                ),
              ),
