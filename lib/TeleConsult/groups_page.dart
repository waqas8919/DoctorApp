...
import 'package:doctorapp/TeleConsult/GeoLocation/geolocation.dart';
import 'package:doctorapp/TeleConsult/charts.dart';
import 'package:doctorapp/TeleConsult/page_navigator.dart';
import 'package:doctorapp/page_navigatorNew.dart';
...
class GroupsPage extends StatefulWidget {
  final PageNavigatorStateNew pageNavigatorState;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          FlutterI18n.translate(context, 'Doctors List'),
          style: TextStyle(
            fontSize: 30,
...
//                  elevation: 24.0,
//                  title: Text(FlutterI18n.translate(context, 'New Member'), style: TextStyle(color: Colors.lightBlue),),
//                  content: TextField(
      ...
      drawer: Drawer(
        child: Scaffold(
          ...
          body:ListView(
            ...
            children: <Widget>[
              ListTile(
                title: Text(FlutterI18n.translate(context, 'Maps')),
                onTap: () {
...
//              ),
              ListTile(
                ...
                title: Text(FlutterI18n.translate(context, 'Language Setting'), style: TextStyle(color: Colors.black)),
                onTap: (){
